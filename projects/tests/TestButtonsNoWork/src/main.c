...
#define TIME_UPDATE_UART  100  //every 10 msec i will control the button
...
TASK(PeriodicTask)
{
   ...
   led_SetToggle(LED_1);
   //uint16_t timeButton;
   // timeButton=(uint16_t)buttonGetTime(&button1);
   int16_t timeButton=2344;
   printf("Hola \n");
   sprintf(out,"Time Press %d ",timeButton);
